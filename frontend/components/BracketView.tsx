...
export default function BracketView({ bracket }: BracketViewProps) {
	...
	const matchesByStage = bracket.reduce(
		(acc, match) => {
	...
	return (
		<div className="w-full">
			...
			<div className="relative">
				...
				<div
					className="absolute left-0 top-0 bottom-8 w-8 bg-gradient-to-r from-slate-50 to-transparent pointer-events-none z-10 lg:hidden"
					aria-hidden="true"
				/>

				{/* Scroll indicator - right */}
				<div
					className="absolute right-0 top-0 bottom-8 w-8 bg-gradient-to-l from-slate-50 to-transparent pointer-events-none z-10 flex items-center justify-end pr-2 lg:hidden"
					aria-hidden="true"
				>
								...
								>
									...
									<div className="mb-6 text-center">
										...
										<div className="text-sm text-slate-600">
											{matches.length}{" "}
											{matches.length === 1 ? t("match") : t("matches")}
										</div>
									</div>
				...
				<div className="mt-8 border-t-2 border-emerald-200 pt-8">
					<div className="max-w-md mx-auto">
						...
						<MatchCard
							...
							prediction={thirdPlaceMatch.prediction}
						/>
					</div>
				</div>
			)}
			...
			<div className="mt-8 p-6 bg-gradient-to-br from-emerald-50 to-white rounded-2xl border-2 border-emerald-200">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-slate-700">
					<div className="flex items-start gap-3 bg-white p-3 rounded-lg border border-emerald-200">
						<span className="font-bold text-emerald-700 min-w-[140px]">
							{t("roundOf32")}:
						</span>
