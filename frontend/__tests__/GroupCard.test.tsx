...
describe('GroupCard', () => {
  const mockGroup = {
    letter: 'A',
    teams: [
      { id: 1, name: 'Germany', flag: '🇩🇪', played: 3, won: 2, draw: 1, lost: 0, goalsFor: 6, goalsAgainst: 2, points: 7, rank: 1 },
      { id: 2, name: 'Scotland', flag: '🏴󠁧󠁢󠁳󠁣󠁴󠁿', played: 3, won: 1, draw: 1, lost: 1, goalsFor: 2, goalsAgainst: 4, points: 4, rank: 2 },
      { id: 3, name: 'Hungary', flag: '🇭🇺', played: 3, won: 1, draw: 0, lost: 2, goalsFor: 2, goalsAgainst: 5, points: 3, rank: 3 },
      { id: 4, name: 'Switzerland', flag: '🇨🇭', played: 3, won: 0, draw: 2, lost: 1, goalsFor: 2, goalsAgainst: 3, points: 2, rank: 4 },
    ]
  }
