						...
						{selectedGroup === null && (
							<div className="mt-12 bg-gradient-to-br from-white to-amber-50 rounded-3xl p-8 border border-amber-200 shadow-lg">
								...
								<p className="text-slate-600 mb-6">
									Best 8 teams finishing 3rd in their groups advance to Round of
									32
								</p>

								<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
									{thirdPlaceQualifiers.map(
										({ group, team, points, gd }, index) => (
											<div
												key={`${group}-${team.id}`}
								...
								<div className="mt-6 p-4 bg-amber-100/50 rounded-xl border border-amber-200">
									...
									<p className="text-sm text-amber-900">
										Third-place teams ranked by: Points → Goal Difference →
										Goals Scored → Fair Play Points
									</p>
								</div>
							</div>
						)}
